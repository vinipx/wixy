...
public class WixyMcpService {
    ...
    @Tool(name = "listStubs", description = "List all active WireMock stub mappings in Wixy")
    public String listStubs() {
        return stubService.listAll().toString();
    }

    @Tool(name = "createStub", description = "Create a new stub mapping from a WireMock JSON string")
    ...
    @Tool(name = "deleteStub", description = "Delete a specific stub mapping by its UUID")
    public void deleteStub(@ToolParam(description = "The UUID of the stub") String id) {
        stubService.delete(UUID.fromString(id));
    }

    @Tool(name = "enableProxy", description = "Enable proxying traffic to a target URL for unmatched requests")
    ...
    @Tool(name = "disableProxy", description = "Disable proxy mode")
    public void disableProxy() {
        proxyService.disableProxy();
    }

    @Tool(name = "startRecording", description = "Start recording traffic and automatically creating stubs")
    ...
    @Tool(name = "stopRecording", description = "Stop the current recording session and return the number of captured stubs")
